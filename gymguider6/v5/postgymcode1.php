...
$whours = "";
if(isset($_POST['s'])){
    $whours=$whours."-saturday"; 

}
if(isset($_POST['sn'])){
     $whours=$whours."-sunday"; 

}
if(isset($_POST['m'])){
   $whours=$whours."-monday"; 
}
if(isset($_POST['tu'])){
     $whours=$whours."-tuesday"; 

}
if(isset($_POST['w'])){
    $whours=$whours."-wednesday"; 

}
if(isset($_POST['t'])){
     $whours=$whours."-thursday";  

}
if(isset($_POST['f'])){
   $whours=$whours."-friday"; 
...
$shours="";
if(isset($_POST['s1'])){
    $shours=$shours."saturday"; 

}
if(isset($_POST['sn1'])){
     $shours=$shours."-sunday"; 

}
if(isset($_POST['m1'])){
   $shours=$shours."-monday"; 
}
if(isset($_POST['tu1'])){
     $shours=$shours."-tuesday"; 

}
if(isset($_POST['w1'])){
    $shours=$shours."wednesday"; 

}
if(isset($_POST['t1'])){
     $shours=$shours."-thursday";  

}
if(isset($_POST['f1'])){
   $shours=$shours."-friday"; 
