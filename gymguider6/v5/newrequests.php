...
<table class="table table-striped">
    ...
    <?php while($row1 = mysqli_fetch_array($result)):; ?>
      <tr>
        <td><a href="adgymdetail.php?id=<?php echo $row1['id'];?>"><?php echo $row1['name']; ?> </a></td>
        <td><?php echo $row1['owner']; ?></td>
        <td><?php echo $row1['country']; ?></td>
        <td><?php echo $row1['city']; ?></td>
        <td> <a href="publish.php?id=<?php echo $row1['id'];?>">publish</a><a href="reject.php?id=<?php echo $row1['id'];?>">/reject</a></td>
      </tr>
      <?php endwhile;?>
