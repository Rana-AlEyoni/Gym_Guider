<?php
    ...
    $sql = "SELECT * FROM feedback WHERE isvalid=0 and usertype='Customer' ";
...
<table class="table table-striped">
    ...
    <?php while($row1 = mysqli_fetch_array($result)):; ?>
      <tr>
        ...
        <td> <a href="deleteshare.php?id=<?php echo $row1['id'];?>">Delete</a></td>
        <td> <a href="approveshare.php?id=<?php echo $row1['id'];?>">Approve</a></td>
