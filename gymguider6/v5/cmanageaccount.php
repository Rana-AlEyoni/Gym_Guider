...
<div class="col-sm-4">
 ...
 <form  action="deleteCustomerAccountStep1.php" method="post">
 <button type="submit" name="submit" class="btn btn-secondary" onclick="return confirm('Are you sure you want to delete your account?');">Delete Account</button> 
</div>
